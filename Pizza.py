class Pizza:
    ...
    def pedido_pizza(self):
        ...
        # Validar la pizza
        self.es_valida = len(self.ingredientes_vegetales) == 2 and \
                         self.validar_ingrediente(self.ingrediente_proteico, self.proteicos_disponibles) and \
                         self.validar_ingrediente(self.tipo_masa, self.tipos_masa)
        if self.es_valida:
            print("¡Pizza válida!")
        else:
